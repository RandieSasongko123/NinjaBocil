...
const PrivacyComp = () => {
  TabTitle("Ninja Bocil | Privacy Policy");
  ...
  return (
    <div className="container-privacy">
      ...
      <div className="detail-privacy">
        <p>
          Effective date: November 22, 2020 <br />
          Genshin-Builds ("us", "we", or "our") operates the
          https://genshin-builds.com/ website (hereinafter referred to as the
          ...
          Privacy Policy for Genshin-Builds is managed with the help of Privacy
          Policies. We use your data to provide and improve the Service. By
          ...
          https://genshin-builds.com/ Information Collection And Use We collect
          several different types of information for various purposes to provide
          and improve our Service to you. Types of Data Collected Personal Data
          While using our Service, we may ask you to provide us with certain
          personally identifiable information that can be used to contact or
          identify you ("Personal Data"). Personally identifiable information
          may include, but is not limited to: Email address First name and last
          name Cookies and Usage Data Usage Data We may also collect information
          on how the Service is accessed and used ("Usage Data"). This Usage
          ...
          not be able to use some portions of our Service. You can learn more
          how to manage cookies in the Browser Cookies Guide. Examples of
          ...
          Security Cookies for security purposes. Use of Data Genshin-Builds
          ...
          do so To provide customer care and support To provide analysis or
          valuable information so that we can improve the Service To monitor the
          ...
          you are located outside Spain and choose to provide information to us,
          please note that we transfer the data, including Personal Data, to
          Spain and process it there. Your consent to this Privacy Policy
          followed by your submission of such information represents your
          agreement to that transfer. Genshin-Builds will take all steps
          ...
          Requirements Genshin-Builds may disclose your Personal Data in the
          ...
          Genshin-Builds To prevent or investigate possible wrongdoing in
          ...
          Of Data The security of your data is important to us, but remember
          ...
          use it for any other purpose. Analytics We may use third-party Service
          Providers to monitor and analyze the use of our Service. Google
          Analytics Google Analytics is a web analytics service offered by
          ...
          Terms web page: https://policies.google.com/privacy?hl=en Advertising
          ...
          view their privacy policy and cookie policy here. You can manage your
          cookies here . We use Google Analytics and Comscore to analyse the use
          of our website. Google Analytics and Comscore gather information about
          ...
          https://www.google.com/policies/privacy/. Comscore’s privacy policy is
          available at https://www.comscore.com/About-comScore/Privacy-Policy.
